...
export default {
  "en": {
    ...
    "mw.rotur.menuBar.login": "Login",
    "mw.rotur.accountMenu.leaderboard": "Leaderboard",
    "mw.rotur.accountMenu.settings": "Settings",
    "mw.rotur.accountMenu.switchAccount": "Switch account",
    "mw.menuBar.myStuff": "My Stuff",
    "mw.menuBar.notifications": "Notifications",
    "mw.rotur.editorNav.myStuff": "My stuff",
    "mw.rotur.editorNav.notifications": "Notifications",
    "mw.loginWarning.title": "Bilup account needs an extra login",
    "mw.loginWarning.message": "After logging in in the editor, you also need to log in to your Bilup account on com.bilup.org to use the full community features.",
    "mw.loginWarning.link": "Go to editor.bilup.org to log in",
    "mw.loginWarning.setupLogin": "Set up login",
    "mw.loginWarning.continue": "I have configured it",
    ...
    "gui.menuBar.compatibility.RemixWarp": "RemixWarp",
    "gui.modal.help": "Help",
    "gui.modal.back": "Back",
  ...
  "zh-cn": {
    ...
    "mw.rotur.menuBar.login": "登录",
    "mw.rotur.accountMenu.leaderboard": "排行榜",
    "mw.rotur.accountMenu.settings": "设置",
    "mw.rotur.accountMenu.switchAccount": "切换账号",
    "mw.menuBar.myStuff": "我的作品",
    "mw.menuBar.notifications": "通知",
    "mw.rotur.editorNav.myStuff": "我的作品",
    "mw.rotur.editorNav.notifications": "通知",
    "mw.loginWarning.title": "Bilup 账户需要额外登录",
    "mw.loginWarning.message": "你在编辑器中登录后，还需要在 com.bilup.org 网站上也登录 Bilup 账户，才能正常使用完整的社区功能。",
    "mw.loginWarning.link": "前往 editor.bilup.org 登录",
    "mw.loginWarning.setupLogin": "设置登录",
    "mw.loginWarning.continue": "我已配置",
    ...
    "gui.gui.listPromptAllSpritesMessage": "此列表将对所有角色可用。",
    ...
    "gui.stageHeader.stageSizeInitial": "初始大小",
